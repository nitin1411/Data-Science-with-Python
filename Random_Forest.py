...
Diabetes = pd.read_csv("c:\\Users\\asus\\Desktop\\Python Codes\\Random Forests\\Diabetes_RF.csv")
Diabetes.head()
Diabetes.columns
...
######################### IRIS data set ##############3
iris = pd.read_csv("c:\\Users\\asus\\Desktop\\Python Codes\\Random Forests\\iris.csv")
iX=iris[["Sepal.Length","Sepal.Width","Petal.Length","Petal.Width"]]
iy=iris[["Species"]]

from sklearn.ensemble import RandomForestClassifier
rfiris = RandomForestClassifier(n_jobs=2,oob_score=True,n_estimators=15,criterion="entropy")
rfiris.fit(iX,iy)
...
salary_train = pd.read_csv("c:\\Users\\asus\\Desktop\\Python Codes\\Random Forests\\SalaryData_Train.csv")
salary_test = pd.read_csv("c:\\Users\\asus\\Desktop\\Python Codes\\Random Forests\\SalaryData_Test.csv")
