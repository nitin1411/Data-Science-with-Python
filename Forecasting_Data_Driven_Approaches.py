...
Amtrak = pd.read_excel("C:\\Users\\nitin\\Downloads\\Python_Unsupervised\\Python_Unsupervised\\Forecasting Contd\\Py code\\Amtrak.xlsx")
...
MAPE(pred_ses,Test.Ridership) # 8.284195400284288

# Holt method 
hw_model = Holt(Train["Ridership"]).fit()
pred_hw = hw_model.predict(start = Test.index[0],end = Test.index[-1])
MAPE(pred_hw,Test.Ridership) # 7.981158383834695
...
MAPE(pred_hwe_add_add,Test.Ridership) # 3.094698688707736
...
MAPE(pred_hwe_add_add, Amtrak.Ridership) #2.4202606210890343
...
MAPE(pred_hwe_mul_add,Test.Ridership) # 3.1183252705860736
